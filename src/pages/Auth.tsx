      ...
      if (mode === "register") {
        ...
        if (error) {
          ...
          toast({
            ...
            description: "Welcome to Kano Kaftan — you're now signed in.",
          });
          navigate("/");
        }
      } else {
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <p className="mt-2 text-muted-foreground">
            {mode === "login"
              ...
              : "Join Kano Kaftan to shop authentic traditional attire"}
          </p>
      ...
      <div className="hidden bg-primary lg:flex lg:w-1/2 lg:items-center lg:justify-center">
        <div className="max-w-md px-8 text-center text-primary-foreground">
          <h2 className="font-display text-4xl font-bold">
            Handcrafted in Kano.<br />Worn with Pride.
          </h2>
          <p className="mt-4 text-lg text-primary-foreground/80">
            Authentic Nigerian Kaftans, Agbada and traditional attire —
            made to order and delivered to your doorstep.
          </p>
        </div>
      </div>
    </div>
